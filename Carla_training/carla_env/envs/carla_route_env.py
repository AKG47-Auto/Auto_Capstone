...
class CarlaRouteEnv(gym.Env):
    ...
    def reset(self, is_training=False):
        ...
        self.prev_slip_angle = 0.0
        self.preview_points = []
        self.slip_angle = 0.0
        self.slip_angle_accum = 0.0
        self.world.tick()
    ...
    def render(self, mode="human"):
        ...
        self.extra_info.extend([
            ...
            "Slip Angle :    % 7.2f" % self.slip_angle,
            "Avg Slip Angle :    % 7.2f" % (self.slip_angle_accum/ self.step_count),
    ...
    def step(self, action):
        ...
        #Slip Angle
        self.prev_slip_angle = self.slip_angle
        self.slip_angle = self.vehicle.get_slip_angle()

        #Accumulated Slip Angle
        self.slip_angle_accum += self.vehicle.get_slip_angle()
        ...
        info = {
            ...
            'avg_slip_angle' : (self.slip_angle_accum/self.step_count),
